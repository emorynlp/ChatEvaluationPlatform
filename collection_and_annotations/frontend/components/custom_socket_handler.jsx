...
function customSocket({
  ...
  function setupWebsocket() {
    ...
    let socketProtocol = browserUrl.hostname === "localhost" || browserUrl.hostname === '0.0.0.0' ? "ws://" : "wss://";
    // let socketProtocol = "ws://"; // todo - uncomment out line above for real deploy!
...
export { customSocket, CONNECTION_STATUS };
